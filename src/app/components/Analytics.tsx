...
export function Analytics() {
  const rpmData = Array.from({ length: 24 }, (_, i) => ({
    hour: i,
    value: 1400 + Math.random() * 150
  }));
      ...
      <div className="bg-[#101A24] rounded-[20px] p-4 border border-white/10">
        ...
        <div className="grid grid-cols-3 gap-2 mt-4">
          <div className="text-center">
            ...
            <p className="text-white text-sm">1,412</p>
          </div>
          <div className="text-center">
            <p className="text-white/50 text-[10px] uppercase">Avg</p>
            <p className="text-white text-sm">1,476</p>
          </div>
          <div className="text-center">
            <p className="text-white/50 text-[10px] uppercase">Max</p>
            <p className="text-white text-sm">1,542</p>
          </div>
        </div>
      </div>
